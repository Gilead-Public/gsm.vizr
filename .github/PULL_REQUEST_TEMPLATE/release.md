...
Milestone: [v0.1.0](https://github.com/Gilead-Public/gsm.vizr/milestone/1)
...
- [ ] Build site `pkgdown::build_site()` and check that all affected examples are displayed correctly and that all new functions occur on the "[Reference](https://gilead-public.github.io/gsm.vizr/reference/index.html)" page. 

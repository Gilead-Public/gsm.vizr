...
### Horizontal stack, pre-aggregated, named colors, captions
...
facet_bars(
  dfFacet, bars_spec(x = "site", fill = "flag"),
...
[`MakeChartConfig()`](https://gilead-public.github.io/gsm.vizr/reference/MakeChartConfig.md).

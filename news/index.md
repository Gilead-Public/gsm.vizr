...
Initial release: an htmlwidgets interface to the gsm.viz JavaScript
library, hosting both of its chart generations against one vendored
gsm.viz 2.4.1 bundle.

- [`bars()`](https://gilead-public.github.io/gsm.vizr/reference/bars.md)/[`facet_bars()`](https://gilead-public.github.io/gsm.vizr/reference/facet_bars.md)
  widgets over one vendored bundle.
- [`bars_spec()`](https://gilead-public.github.io/gsm.vizr/reference/bars_spec.md)/[`facet_spec()`](https://gilead-public.github.io/gsm.vizr/reference/facet_spec.md)
...
- [`barsOutput()`](https://gilead-public.github.io/gsm.vizr/reference/bars-shiny.md)/[`renderBars()`](https://gilead-public.github.io/gsm.vizr/reference/bars-shiny.md)/[`bars_proxy()`](https://gilead-public.github.io/gsm.vizr/reference/bars_proxy.md)
...
- Relocated the legacy KRI widget wrappers from gsm.kri
  ...
  and the shared widget-control JS/CSS.
